        ...
        <div class="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div class="lg:col-span-7">
            ...
            <div class="hero-badge inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-cs-600/30 bg-cs-600/10 mb-8">
              ...
              <span class="text-xs font-bold text-cs-300 uppercase tracking-widest">Service-Disabled Veteran-Owned Small Business</span>
            </div>
            ...
            <h1 class="hero-h1 text-4xl sm:text-5xl lg:text-6xl xl:text-[4.25rem] font-extrabold text-white leading-[1.08] tracking-tight text-balance">
              We Help Organizations <br class="hidden xl:block" />
              <span class="text-cs-500">Achieve More.</span>
            </h1>
            ...
            <div class="hero-stats mt-16 grid grid-cols-3 gap-8 max-w-lg">
              <div>
                <div class="text-3xl font-extrabold text-white">SDVOSB</div>
                <div class="mt-1 text-xs font-medium text-slate-500 uppercase tracking-wider">Certified</div>
              </div>
              <div class="border-l border-slate-800 pl-8">
                <div class="text-3xl font-extrabold text-white">100<span class="text-cs-500">+</span></div>
                <div class="mt-1 text-xs font-medium text-slate-500 uppercase tracking-wider">Projects</div>
              </div>
              <div class="border-l border-slate-800 pl-8">
                <div class="text-3xl font-extrabold text-white">24/7</div>
                <div class="mt-1 text-xs font-medium text-slate-500 uppercase tracking-wider">Support</div>
              </div>
            </div>
          </div>
