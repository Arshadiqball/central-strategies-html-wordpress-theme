<?php
/**
 * Site footer — dark three-column layout + credentials + legal row.
 *
...
?>
  <footer class="bg-[#080910] text-slate-400">
    ...
    <div class="max-w-site mx-auto px-5 lg:px-8 pt-14 pb-10">
      <div class="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-x-10 xl:gap-x-14">
        ...
        <!-- Column 2: Company -->
        <div class="lg:col-span-3 lg:pt-1" data-animate="fade-up">
        ...
        <!-- Column 3: Contact -->
        <div class="lg:col-span-4 lg:pt-1" data-animate="fade-up">
